...
//	http://localhost:8080/book-api/v1/books/bookid/1
	@DeleteMapping("/books/admin/bookid/{bookId}")
...
//	http://localhost:8080/book-api/v1/books/bookid/1
	@GetMapping("/books/admin/bookid/{bookId}")
...
//	http://localhost:8080/book-api/v1/books/author/title?auth=kathy&title=java
	...
	ResponseEntity<List<Book>> getByAuthTitle(@RequestParam("auth") String author, @RequestParam("title") String title) {
